...
namespace base58
{
    size_t encode(unsigned __int64 id_num, char* output, size_t output_len)
    {
        if (output == 0)
            return 0;
    ...
    bool decode(const char* encoded, size_t encoded_len, unsigned __int64* output)
    {
